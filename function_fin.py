...
def make_pos_voca(df_train, keyword, raworcsv='csv'):
    ...
    if raworcsv == 'csv':
        ...
        pickle.dump(pos_voca, open("Is It Good/save_pos_voca_pkl/pos_voca_{}.pkl".format(keyword), "wb"))
        return pos_voca
    else:
        for i in range(len(df_train)):
...
def read_pos_voca(keyword):
    pos_voca = pickle.load(open("Is It Good/save_pos_voca_pkl/pos_voca_{}.pkl".format(keyword), "rb"))
    return pos_voca
...
def Vectorizer_train(df_train, keyword, stop_words=None):
    ...
    pickle.dump(vect, open("Is It Good/save_vect_pkl/vect_{}.pkl".format(keyword), "wb"))
...
def Vectorizer_test(df_input, keyword):
    ...
    """
    vect = pickle.load(open("Is It Good/save_vect_pkl/vect_{}.pkl".format(keyword), "rb"))
